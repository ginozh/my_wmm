#ifndef QAV_TESTDEMUXER_H
#define QAV_TESTDEMUXER_H
...
class AVError;
class MediaIO;
class Q_AV_EXPORT TestAVDemuxer : public QObject
{
    Q_OBJECT
public:
    ...
    TestAVDemuxer(QObject *parent = 0);
    ~TestAVDemuxer();
...
private:
    ...
    friend class TestInterruptHandler;
};

#endif // QAV_TESTDEMUXER_H
