...
void OBSBasic::RefreshSceneCollections()
{
	...
	const char *cur_name = config_get_string(RecordGlobal::instance()->GlobalConfig(), "Basic",
						 "SceneCollection");
...
void OBSBasic::on_actionRenameSceneCollection_triggered()
{
	...
	std::string oldFile = config_get_string(RecordGlobal::instance()->GlobalConfig(), "Basic",
						"SceneCollectionFile");
	const char *oldName = config_get_string(RecordGlobal::instance()->GlobalConfig(), "Basic",
						"SceneCollection");
...
void OBSBasic::on_actionRemoveSceneCollection_triggered()
{
	...
	std::string oldFile = config_get_string(RecordGlobal::instance()->GlobalConfig(), "Basic",
						"SceneCollectionFile");
	std::string oldName = config_get_string(RecordGlobal::instance()->GlobalConfig(), "Basic",
						"SceneCollection");
	...
	const char *newFile = config_get_string(RecordGlobal::instance()->GlobalConfig(), "Basic",
						"SceneCollectionFile");
...
void OBSBasic::ChangeSceneCollection()
{
	...
	const char *newName = config_get_string(RecordGlobal::instance()->GlobalConfig(), "Basic",
						"SceneCollection");
	const char *newFile = config_get_string(RecordGlobal::instance()->GlobalConfig(), "Basic",
						"SceneCollectionFile");
