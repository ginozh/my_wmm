...
public:
    ...
    QLabel *mixerAddonLabel;
    QComboBox *mixerAddonDropdown;
    QWidget *outputPage;
    ...
    void setupUi(QDialog *OBSBasicSettings)
    {
        ...
        mixerAddonLabel = new QLabel(streamKeyPage);
        mixerAddonLabel->setObjectName(QString::fromUtf8("mixerAddonLabel"));

        streamkeyPageLayout->setWidget(8, QFormLayout::LabelRole, mixerAddonLabel);

        mixerAddonDropdown = new QComboBox(streamKeyPage);
        mixerAddonDropdown->setObjectName(QString::fromUtf8("mixerAddonDropdown"));

        streamkeyPageLayout->setWidget(8, QFormLayout::FieldRole, mixerAddonDropdown);
        ...
        scrollAreaWidgetContents_3->setGeometry(QRect(0, 0, 603, 631));
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 596, 781));
        ...
        mixerAddonLabel->setBuddy(mixerAddonDropdown);
    ...
    void retranslateUi(QDialog *OBSBasicSettings)
    {
        ...
        mixerAddonLabel->setText(QCoreApplication::translate("OBSBasicSettings", "Basic.Settings.Stream.MixerAddon", nullptr));
