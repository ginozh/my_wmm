...
g++ -shared -o myopengl.dll opengl.o -Wl,-subsystem,windows -mthreads -Wl,--out-implib,libmyopengl.dll.a -lopengl32 /mingw64/lib/libglew32.a /mingw64/lib/libglfw3.a
