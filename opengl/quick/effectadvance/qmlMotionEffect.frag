...
float CurRotate = 90.0;//45.0;//0.0;//iGlobalTime*360.0/25.0;//sin(iGlobalTime*5.9)*360.0;//degree
...
void main() 
{
    ...
    gl_FragColor = texture2D(mSample1, uv);
    return;
}
#endif

#if 0
vec2 iResolution = gl_FragCoord.xy / qt_TexCoord0;
