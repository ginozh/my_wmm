...
{
	// AsyncCallback  [Class with Template]
	//
    // A class that implements IMFAsyncCallback. IMFAsyncCallback:: Invoke Call,
    // Route to the specified method of the specified instance.
    // Use when you want to implement multiple IMFAsyncCallbacks in a class.
    //
    // Example:
	//
