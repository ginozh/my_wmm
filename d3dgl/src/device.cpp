...
BOOL D3DGLDevice::ShowCursor(BOOL show)
{
...
HRESULT D3DGLDevice::SetDialogBoxMode(BOOL enable)
{
...
HRESULT D3DGLDevice::CreateRenderTarget(UINT width, UINT height, D3DFORMAT format, D3DMULTISAMPLE_TYPE multisample, DWORD multisampleQuality, BOOL lockable, IDirect3DSurface9 **surface, HANDLE *handle)
{
...
HRESULT D3DGLDevice::CreateDepthStencilSurface(UINT width, UINT height, D3DFORMAT format, D3DMULTISAMPLE_TYPE multisample, DWORD multisampleQuality, BOOL discard, IDirect3DSurface9 **surface, HANDLE *handle)
{
...
HRESULT D3DGLDevice::LightEnable(DWORD index, BOOL enable)
{
    FIXME("iface %p, index %lu, enable %u : stub!\n", this, index, enable);
    return E_NOTIMPL;
}

HRESULT D3DGLDevice::GetLightEnable(DWORD index, BOOL *enable)
{
...
HRESULT D3DGLDevice::SetSoftwareVertexProcessing(BOOL software)
{
    FIXME("iface %p, software %u : stub!\n", this, software);
    return E_NOTIMPL;
}

BOOL D3DGLDevice::GetSoftwareVertexProcessing()
{
    FIXME("iface %p : stub!\n", this);
    return E_NOTIMPL;
}
...
HRESULT D3DGLDevice::SetVertexShaderConstantB(UINT start, const BOOL *values, UINT count)
{
    FIXME("iface %p, start %u, values %p, count %u : stub!\n", this, start, values, count);
    return E_NOTIMPL;
}

HRESULT D3DGLDevice::GetVertexShaderConstantB(UINT start, BOOL *values, UINT count)
{
    FIXME("iface %p, start %u, values %p, count %u : stub!\n", this, start, values, count);
    return E_NOTIMPL;
}
...
HRESULT D3DGLDevice::SetPixelShaderConstantB(UINT start, const BOOL *values, UINT count)
{
    FIXME("iface %p, start %u, values %p, count %u : stub!\n", this, start, values, count);
    return E_NOTIMPL;
}

HRESULT D3DGLDevice::GetPixelShaderConstantB(UINT start, BOOL *values, UINT count)
{
    FIXME("iface %p, start %u, values %p, count %u : stub!\n", this, start, values, count);
    return E_NOTIMPL;
}
