...
public:
    ...
    virtual BOOL WINAPI ShowCursor(BOOL show) final;
    ...
    virtual HRESULT WINAPI SetDialogBoxMode(BOOL enable) final;
    ...
    virtual HRESULT WINAPI CreateRenderTarget(UINT width, UINT height, D3DFORMAT format, D3DMULTISAMPLE_TYPE multisample, DWORD multisampleQuality, BOOL lockable, IDirect3DSurface9 **surface, HANDLE *handle) final;
    virtual HRESULT WINAPI CreateDepthStencilSurface(UINT width, UINT height, D3DFORMAT format, D3DMULTISAMPLE_TYPE multisample, DWORD multisampleQuality, BOOL discard, IDirect3DSurface9 **surface, HANDLE *handle) final;
    ...
    virtual HRESULT WINAPI LightEnable(DWORD Index, BOOL Enable) final;
    virtual HRESULT WINAPI GetLightEnable(DWORD Index, BOOL* pEnable) final;
    ...
    virtual HRESULT WINAPI SetSoftwareVertexProcessing(BOOL bSoftware) final;
    virtual BOOL WINAPI GetSoftwareVertexProcessing() final;
    ...
    virtual HRESULT WINAPI SetVertexShaderConstantB(UINT StartRegister, const BOOL* pConstantData, UINT  BoolCount) final;
    virtual HRESULT WINAPI GetVertexShaderConstantB(UINT StartRegister, BOOL* pConstantData, UINT BoolCount) final;
    ...
    virtual HRESULT WINAPI SetPixelShaderConstantB(UINT StartRegister, const BOOL* pConstantData, UINT  BoolCount) final;
    virtual HRESULT WINAPI GetPixelShaderConstantB(UINT StartRegister, BOOL* pConstantData, UINT BoolCount) final;
