...
//				AV_PIX_FMT_RGB24,
			...
			//snprintf(filter_args, sizeof(filter_args), "time_base=%d/%d:sample_rate=%d:sample_fmt=%s:channel_layout=0x%" PRIx64, //storm
			snprintf(filter_args, sizeof(filter_args), "time_base=%d/%d:sample_rate=%d:sample_fmt=%s:channel_layout=0x%ld",
						clip->stream->time_base.num,
						clip->stream->time_base.den,
