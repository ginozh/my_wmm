...
CONFIG += c++11
QMAKE_CFLAGS += -DNOFREI0R
QMAKE_CXXFLAGS += -DNOFREI0R
...
win32 {
    #INCLUDEPATH += 'C:/Program Files (x86)/frei0r/include/'
    #LIBS += -L 'C:/Program Files (x86)/frei0r/lib/frei0r-1/'
    RC_FILE = packaging/windows/resources.rc
    INCLUDEPATH += c:/msvc_ffmpeg/include/
    LIBS += -Lc:/msvc_ffmpeg/lib/ -Lc:/msvc_ffmpeg/bin/
